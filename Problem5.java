...
public class Problem5
{
  ...
  {
    return (((year-1930) % 4 ==0) && (year >= 1930));              // the difference between a world cup year and the original year (1930)
    //  can be thought of as a multiple of 4 and divisble by 4
  }
