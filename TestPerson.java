...
public class TestPerson {
  ...
  public static void main(String[] args){
    ...
    Person p2 = new Person("Kofi", 19);
    Person p3 = new Person("Mansah", 4);
    Person p4 = new Person("Bob", 4);
    ...
    //Test the getNumpersons method
    System.out.println("the number of people is " + Person.getNumPersons());
    
    //test the createadult and creattoddler methods
    System.out.println(Person.creatAdult().getName() + " " + Person.creatAdult().getAge());
    
    System.out.println(Person.creatToddler().getName() + " " + Person.creatToddler().getAge());
